  ...
  return [
    {
      ...
      unit: "mmHg",
      time: v?.measured_at || "Sin registros",
    ...
    },
    {
      ...
      value: v?.heart_rate ? String(v.heart_rate) : "--",
      unit: "bpm",
      time: v?.measured_at || "Sin registros",
    ...
    },
    {
      id: "vs-3",
      name: "Temperatura",
      value: v?.temperature ? String(v.temperature) : "--",
      unit: "°C",
      time: v?.measured_at || "Sin registros",
    ...
    },
    {
      ...
      value: v?.oxygen_saturation ? String(v.oxygen_saturation) : "--",
      unit: "%",
      time: v?.measured_at || "Sin registros",
