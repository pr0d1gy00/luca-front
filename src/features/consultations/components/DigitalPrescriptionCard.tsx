...
export function DigitalPrescriptionCard({
  ...
  return (
    <div className="flex flex-col gap-6 bg-white rounded-3xl border border-slate-200/80 p-8 max-w-2xl mx-auto">
      {/* ── Header ─────────────────────────────────────────── */}
      <div className="flex items-start justify-between">
        {/* Doctor Info */}
        <div className="flex items-center gap-4">
          <div className="size-14 rounded-2xl bg-pharmako-care-light flex items-center justify-center">
        ...
        <div className="flex flex-col items-end gap-1">
          ...
          <Badge
            variant="outline"
            className="rounded-full text-xs font-mono mt-1 bg-pharmako-care-light border-pharmako-care/30 text-pharmako-care"
          >
            Receta Digital
          </Badge>
        </div>
