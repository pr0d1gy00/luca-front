                ...
                <div className="flex-1 min-w-0">
                  {editingLabel === field.key ? (
                    <input
                      ...
                      className="w-full px-1.5 py-0.5 rounded border border-pharmako-care/40 text-xs text-slate-700 bg-white
                                 focus:outline-none focus:ring-2 focus:ring-pharmako-care/20"
                    />
                  ) : (
                    <button
                      onClick={(e) => {
                      ...
                      className="text-xs font-medium text-slate-600 hover:text-pharmako-care transition-colors text-left w-full truncate"
            ...
            {availableOptions.map((opt) => (
              <button
                ...
                className="inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs text-slate-500
                            bg-slate-50 border border-slate-100 hover:border-pharmako-care-hover hover:text-pharmako-care
                            hover:bg-pharmako-care-light transition-colors"
              >
