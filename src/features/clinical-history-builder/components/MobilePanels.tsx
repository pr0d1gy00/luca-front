            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-10 h-6 rounded-full transition-colors ${
                  selectedElement.required ? "bg-pharmako-care" : "bg-slate-200"
                }`}
              >
                <div
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 flex gap-1 bg-white rounded-2xl shadow-lg border border-slate-100 p-1.5">
      ...
      <button
        ...
        className="px-4 py-2 rounded-xl text-sm font-medium text-pharmako-care bg-pharmako-care-light transition-colors"
      >
        Editar
      </button>
    </div>
