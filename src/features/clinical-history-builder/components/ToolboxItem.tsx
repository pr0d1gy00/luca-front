...
export function ToolboxItem({
  ...
  return (
    ...
    >
      {/* Icon */}
      <div className="p-2 rounded-lg text-pharmako-care group-hover:text-pharmako-care-hover group-hover:bg-pharmako-care-light/80 group-hover:border-pharmako-care/40 transition-colors shrink-0">
