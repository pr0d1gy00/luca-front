                ...
                {editingIndex === idx ? (
                  <input
                    ...
                    className="w-full px-1.5 py-1 rounded border border-slate-200 text-xs text-slate-600 bg-white
                               focus:outline-none focus:border-blue-700 focus:ring-1 focus:ring-blue-700/20"
                  />
                ) : (
                  <button
              ...
              <div className="flex-1 min-w-0">
                {editingIndex === idx ? (
                  <input
                    ...
                    className="w-full px-2 py-1 rounded border border-blue-200 text-xs text-slate-700 bg-white
                               focus:outline-none focus:border-blue-700 focus:ring-1 focus:ring-blue-700/20"
                  />
                ) : (
                  <button
