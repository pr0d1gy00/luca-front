  ...
  const directoryLinks = [
    {
      ...
      href: "/doctors",
      icon: Stethoscope,
      desc: "Busca médicos y agendas",
    },
    {
      label: "Farmacias",
      href: "/pharmacies",
      icon: Pill,
      desc: "Encuentra medicamentos y sucursales",
    },
    {
      label: "Clínicas",
      href: "/clinics",
      icon: Building2,
      desc: "Centros médicos y laboratorios",
    },
  ];

  const mobileLinks = [...baseLinks, authLink, ...directoryLinks];
